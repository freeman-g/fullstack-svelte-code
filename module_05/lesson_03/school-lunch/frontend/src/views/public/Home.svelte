...
<div class="notification">
  <div class="columns">
    <div class="column">
      <div class="content">
        <h1 class="title is-4">Easily Publish Your School Lunch Menus</h1>
    ...
    <div class="column">
      <div class="content">
        ...
        <div class="field">
          ...
          <div class="control">
            <!-- HERE!!!! -->
            <input bind:value="{emailAddress}" type="text" placeholder="Enter your email address" class="input" />
          </div>
        </div>
        <div class="field">
          ...
          <div class="control">
            <!-- AND HERE!!!! -->
            <input bind:value="{schoolName}" type="text" placeholder="Enter your school's name" class="input" />
          </div>
        </div>
